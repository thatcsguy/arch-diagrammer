...
export function DatabaseNode({ data, selected }: NodeProps<DiagramNode>) {
  return (
    <div
    ...
    >
      <div className="text-xs text-green-400 font-semibold uppercase tracking-wide mb-1">Database</div>
